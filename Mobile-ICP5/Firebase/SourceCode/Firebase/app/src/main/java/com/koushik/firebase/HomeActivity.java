...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDel = (Button) findViewById(R.id.btn_delet);
        btnDelUser = (Button) findViewById(R.id.btn_deletUser);

        mFirebaseInstance = FirebaseDatabase.getInstance();
        // get reference to 'users' node
        mFirebaseDatabase = mFirebaseInstance.getReference("users");
        // store app title to 'app_title' node
        mFirebaseInstance.getReference("app_title").setValue("RealtimeDatabase");
        ...
        mFirebaseInstance.getReference("app_title").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(HomeActivity.this, "Reading app title from Database", Toast.LENGTH_SHORT).show();
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mFirebaseInstance.getReference("users").removeValue();
                Toast.makeText(HomeActivity.this, "Deleted the user", Toast.LENGTH_SHORT).show();
            }
        });
